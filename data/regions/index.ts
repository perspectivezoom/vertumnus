import ny from '@/data/regions/__generated__/ny';
import sfbay from '@/data/regions/__generated__/sfbay';
 ...
 * the crop lists in data/regions/; edit those, never the output.
 */
